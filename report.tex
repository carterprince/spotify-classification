...
\begin{itemize}
    ...
    \item \textbf{Impact of Correlation:} Gaussian Naive Bayes yielded the lowest accuracy (36.50\%). This confirms the hypothesis derived from the EDA: the strong correlations between features (e.g., Energy and Loudness) violate the independence assumption of Naive Bayes, degrading its performance.
\end{itemize}
