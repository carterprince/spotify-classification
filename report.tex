...
\begin{enumerate}
    ...
    \item \textbf{Dimensionality Reduction:} While tree-based models handled the full feature set well, distance-based models like KNN suffered from high dimensionality. Future studies should apply Principal Component Analysis (PCA) or manually remove features with low separability (such as \texttt{key} and \texttt{mode}) to reduce noise and computational cost.
\end{enumerate}
